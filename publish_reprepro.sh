...
aptly publish repo $DIST -passphrase="$pass" -batch -force-overwrite=true -config="/aptly/aptly.conf"  -distribution=$DIST -component="$cop" || aptly publish repo $DIST -passphrase="$pass" -batch -component="$cop"
